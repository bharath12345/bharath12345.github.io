...
Category: posts
Tags: 
Slug: my-scala-application---twitter-volume-grapher-for-indian-election-personalities
Toc: true
...
* ##### 3 Seconds Tweet Aggregate Grapher  
  ...
  * Dashboard Sample Image:   
       <a href="/images/twitterdashboard/my%20twitter%20dashboard%202014-02-27%2019-05-58.png">![image](/images/twitterdashboard/my%20twitter%20dashboard%202014-02-27%2019-05-58.png =430x238)</a>
  * Details: 
...
* ##### 30 Seconds Tweet Aggregate Grapher
  ...
  * Dashboard Sample Image:   
       <a href="/images/twitterdashboard/my%20twitter%20dashboard%202014-02-27%2019-06-30.png">![image](/images/twitterdashboard/my%20twitter%20dashboard%202014-02-27%2019-06-30.png =430x238)</a>
  * Details: 
...
* ##### 5 Minutes Tweet Aggregate Grapher
  ...
  * Dashboard Sample Image:
       <a href="/images/twitterdashboard/my%20twitter%20dashboard%202014-02-27%2019-27-42.png">![image](/images/twitterdashboard/my%20twitter%20dashboard%202014-02-27%2019-27-42.png =430x238)</a>
  * Details: 
...
* ##### 30 Minutes Tweet Aggregate Grapher
  ...
  * Dashboard Sample Image:
       <a href="/images/twitterdashboard/my%20twitter%20dashboard%202014-02-27%2023-20-24.png">![image](/images/twitterdashboard/my%20twitter%20dashboard%202014-02-27%2023-20-24.png =430x238)</a>
  * Details: 
...
* The design flow essence is captured in this image - 
    ...
    <a href="/images/twitterdashboard/algo.png">![image](/images/twitterdashboard/algo.png =1000x200)</a>
...
The graph may not appear if you are a behind a proxy which does not tunnel WebSockets (like behind some of the office networks). Also if a firewall blocks WebSockets. But in case you run into any of these issues, then you could use your **mobile device** to see the dashboard. Here is the screenshot from my Android Samsung S2 on my home Wifi. I also checked that the graphing works on my Airtel 2G network fairly well too (the dots in the image below are some mess-up by the mobile screenshot tool)
   ...
   <a href="/images/twitterdashboard/2014_02_27_19.51.35.png">![image](/images/twitterdashboard/2014_02_27_19.51.35.png =220x200)</a>
