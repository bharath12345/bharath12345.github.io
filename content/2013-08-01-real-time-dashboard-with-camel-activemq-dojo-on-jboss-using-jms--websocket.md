...
Category: posts
Tags: 
Slug: real-time-dashboard-with-camel-activemq-dojo-on-jboss-using-jms--websocket
Toc: true
...
![image](/images/camel-websocket/camel%20jms%20websocket.png)
...
![image](/images/camel-websocket/jmx.png)

The snapshot of the dashboard UI -

![image](/images/camel-websocket/dashboard.png)
